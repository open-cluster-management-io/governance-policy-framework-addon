...
replace (
	github.com/antlr/antlr4/runtime/Go/antlr/v4 => github.com/antlr/antlr4/runtime/Go/antlr/v4 v4.0.0-20230305170008-8188dc5388df // Replaced so that 'go get -u' works. Remove/bump when upgrading.
